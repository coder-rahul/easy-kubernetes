 ...
 #  Provision Load Balancer Node
  config.vm.define "loadbalancer" do |node|
   ...
   node.vm.network :private_network, ip: IP_NW + "#{LB_IP_START}"
    ...
    node.vm.provision "setup-lb", type: "shell", :path => "ubuntu/vagrant/setup_lb.sh"
...
#		node.vm.provision "setup-kubernetes", type: "shell", :path => "ubuntu/vagrant/setup_kubernetes.sh"
